...
date: 2023/10/08
description: Learn the steps to contribute to an open-source project on GitHub.
tag: foss, github, open-source, git, contribution, pull-request
author: Archit Rathod
image: /assets/blogs/opensource-contribution-guide.webp
---
