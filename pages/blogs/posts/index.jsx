...
const BlogPostsIndex = () => {
    ...
    return (
        <>
            ...
            <Head>
                <title>Blog Posts | Archit Rathod</title>
                <meta
                    name="description"
                    content="Read my latest blog posts on web development, design, life and technology."
                />
                <meta property="og:title" content="Blog Posts | Archit Rathod" />
                <meta property="og:description" content="My latest articles on web development, coding and life." />
            </Head>
