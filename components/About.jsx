...
const About = () => {
    return (
        <section
            id="about"
            className="w-full md:h-screen p-2 flex items-center pt-16 py-8 dark:bg-gray-900"
        >
            <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
                <div className="col-span-2">
                    ...
                    {about.map((para, index) => {
                        return (
                            <p key={index} className="py-2 text-gray-600 dark:text-gray-300">
                                {para}
                            </p>
                        );
                    })}
                    ...
                    <a href="#projects">
                        <p className="py-2 text-gray-600 dark:text-gray-300 underline cursor-pointer hover:text-[#5651e5] dark:hover:text-[#a29bfe]">
                            Check out some of my latest projects
                        </p>
                    </a>
                </div>
                <div className="w-[60%] md:w-[90%] my-auto mx-auto rounded-xl shadow-xl shadow-gray-400 dark:shadow-gray-800 p-3 flex items-center justify-center hover:scale-105 ease-in duration-300">
                    <Image
                        height={500}
                        width={500}
                        className="rounded-xl"
