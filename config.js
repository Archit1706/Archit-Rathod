...
const researchs = [
    {
        ...
        links: {
            ...
            code: "",
            dataset: "",
            publisher: "https://link.springer.com/chapter/10.1007/978-981-97-0327-2_23",
        ...
        publisher: "Proceedings of ICSISCET 2023, Artificial Intelligence and Sustainable Computing",
        volume: "",
        pages: "",
        year: "2024",
        doi: "",
    ...
    },
    {
        ...
        alt: "Ascend.AI Building Confidence Through Technology: A Technical Exploration of Facial Expression, Tone, and Pitch Analysis with Chatbot Guidance",
        url: "/ascendai-building-confidence-through-technology-a-technical-exploration-of-facial-expression-tone-and-pitch-analysis-with-chatbot-guidance",
        ...
        links: {
            arxiv: "",
            openreview: "",
            publication: "https://link.springer.com/chapter/10.1007/978-981-96-1185-0_6",
            slides: "https://pitch.com/v/ascendai-paper-ppt-te9882",
            video: "",
            poster: "",
            blog: "",
            code: "https://github.com/Archit1706/AscendAI",
            pdf: "https://link.springer.com/chapter/10.1007/978-981-96-1185-0_6",
        },
        desc: "",
        technology: ["", "", ""],
        abstract: "The proposed approach embarks on an intricate and comprehensive exploration of advanced and innovative technologies to enhance interview skills. Leveraging the power of OpenCV and Xception, the paper delves into the nuances of facial expression analysis, unraveling the intricacies of emotion recognition. The system is analyzing tone and pitch with the aid of tools like LIBROSA to extract vocal features in order to understand the intensity of emotions and has developed a 1DCNN model for classification using RAVDESS, TESS, SAVEE, and CREMA-D datasets. The system includes a chatbot, using Vector database called Qdrant and an open-source LLM Mixtral 8x7b, offering personalized interview guidance derived from scraping 30 diverse websites for interview-related questions. This technical exploration extends from conventional interview preparation to introducing an innovative framework that intertwines machine learning models with real-time analysis. “Building Confidence Through Technology” presents an innovative approach, synergizing technological prowess to elevate interview skills and foster unwavering confidence.",
        conclusion: "In conclusion, the proposed Ascend.ai system leverages advanced machine learning techniques to enhance interview preparation by focusing on nonverbal and verbal communication skills. The integration of facial expression analysis and tone and pitch analysis provides a comprehensive tool for users to receive real-time feedback on their emotional expressions and vocal characteristics during mock interviews. Evaluation results demonstrate the effectiveness of the models in both facial and voice emotion recognition, with high accuracy and robust performance across various emotion categories. The confusion matrix analysis and classification reports confirm the models’ ability to generalize and provide precise feedback. Overall, Ascend.ai is a powerful AI-driven tool that empowers users to improve their interview skills through detailed, real-time insights into their nonverbal and verbal communication. This comprehensive approach not only enhances users’ confidence and professionalism but also equips them with the necessary skills to excel in interviews. Future work could explore integrating advanced machine learning techniques for resume evaluation to provide holistic interview preparation. Additionally, one can leverage natural language processing for analyzing interview responses and incorporate virtual reality to simulate real-world interview environments which could further enhance the system’s capabilities. These enhancements would offer users a more immersive and comprehensive preparation experience.",
        keyFeatures: [
            "Facial Expression Analysis with OpenCV and Xception",
            "Tone and Pitch Analysis using LIBROSA and 1DCNN",
            "Personalized Chatbot Guidance with Qdrant and Mixtral 8x7b",
            "Comprehensive Interview Preparation Tool",
            "Real-Time Feedback on Nonverbal and Verbal Communication",
        ],
        conference: "",
        dates: {
            working: "March 2024",
        ...
        // date: "October 21-22, 2023",
        series: "Lecture Notes in Networks and Systems, Volume 1237",
        publisher: "Springer",
        volume: "5",
        pages: "",
        year: "2025",
        doi: "",
        isbn: "",
        booktitle: "Data Science and Applications, Proceedings of ICDSA 2024",
        editor: "",
        organization: "",
        address: "",
        school: "",
